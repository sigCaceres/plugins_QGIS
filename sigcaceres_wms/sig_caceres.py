...
class SigCaceres:
    ...
    # def run_ejemplo(self):
    #     """
    #     Ejemplo de combobox y botones
    #     @return:
    #     """
    #     dlg_ej = NombreDeLaClase()
    #     dlg_ej.show()
    #     listar_capas_combobox(dict_capas=dict_capas_carril_bici, combobox=dlg_ej.comboBox_capas)
